...
from scripts.miro_source_expansion_workflow import (  # noqa: E402
    build_workflow_plan,
    render_next_actions,
    run_analysis,
...
from scripts.miro_capability_probe import build_coverage_rows  # noqa: E402
...
class MiroSourceExpansionWorkflowTests(unittest.TestCase):
    def test_plan_contains_ordered_commands_without_secret_value(self) -> None:
        ...
        self.assertIn("python -m scripts.miro_rest_generate_probe_board --output", plan)
        self.assertIn("MIRO_ACCESS_TOKEN", plan)
        self.assertIn("system browser", plan)
        ...
        self.assertIn("python -m scripts.miro_slide_probe", plan)
        self.assertIn("slide_probe_result.json", plan)
        self.assertIn("python -m scripts.miro_source_expansion_workflow analyze", plan)
