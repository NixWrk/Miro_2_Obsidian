...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("image", YES, YES, LIMITED, "createImage", "file node", "supported"),
    Capability("document", OBSERVED, LIMITED, UNKNOWN, NO, "file node", "supported", "REST enum/export can expose documents."),
    ...
    Capability("embed", YES, YES, UNKNOWN, "createEmbed", "file/link/diagnostic node", "supported"),
